...
class UserAdmin(BaseUserAdmin):
    fieldsets = (
        (None, {
            'fields': ('email', 'password', 'name', 'sex', 'birthday', 'job_number', 'zhengzhi_mianmao', 'zhengzhi_time', 'job', 'job_time', 'job_2', 'id_number', 'xueli', 'school', 'graduate_time', 'job_join_time', 'team_belong', 'phone', )
        }),
        (_('Permissions'), {
